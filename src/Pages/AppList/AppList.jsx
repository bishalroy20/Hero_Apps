...
const AppList = () => {
  ...
  if (loading) return <Loading message="Loading apps..." />;
      ...
      {filteredApps.length !== 0 ? (
        ...
        <div className="my-10">
          ...
          <div>
            ...
            <p className="font-medium text-[20px] text-gray-600 text-center">
          ...
          <Link to="/AppList">
            <div className="text-center my-8">
              <button
                ...
                className="btn bg-gradient-to-br from-[#632EE3] to-[#9F62F2] text-white px-10"
              >
                Show All
              </button>
            </div>
